...
p.setup = function() {
 ...
 p.draw = function() {
  ...
  if(interruttore === 1){
    ...
    p.textSize(20);
    p.fill('#fff250');
    p.text('Welcome! \n You are in a noisy, crowded station and you need \nto get to the British Museum in London as soon \nas possible. The timetable is really full of informations, try to cover the webcam to understand better which train is useful to reach the destination',
    correctCanvasWidth / 2, correctCanvasHeight / 2 + 70, 550, 300);
    p.pop();
